...
const DoctorMeetingConference = () => {
  ...
  const fetchAppointmentDetails = async () => {
    try {
      const response = await axios.get(`https://pms-d9fj.onrender.com/api/appointments/${appointmentId}`); // Assuming you have a backend route to get appointment details
